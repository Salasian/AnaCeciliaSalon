        ...
        <div className="row">
          <article className={`col-sm-6 ${style.columna}`}>
            ...
            <p>
              ...
              alta calidad hacia sus clientes sean de la mejor calidad y la
              mejor experiencia, entre los servicios se ofrecen:
            </p>
          ...
          <aside className={`col-4 d-flex flex-column ${style.menuContainer}`}>
            <div className={`d-flex flex-column ${style.sesion}`}>
              ...
              <button onClick={() => setGoToSignIn(true)}>Crea cuenta</button>
              ...
              <button onClick={() => setGoToLogin(true)}>Acceder</button>
            </div>
          </aside>
        </div>
      </div>
